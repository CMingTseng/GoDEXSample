...
public class Tool extends Connect {
    ...
    private Button sendButton, disconnectButton, testcommandButton, printButton, settingButton, uploadButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        testcommandButton = (Button) findViewById(R.id.testcommand);
        testcommandButton.setOnClickListener
                (new OnClickListener() {
                     public void onClick(View v) {
                         Godex.sendCommand("^XSET,IMMEDIATE,1");
                         Godex.sendCommand("^XSET,ACTIVERESPONSE,1");
                         Godex.sendCommand("~V");
                         Godex.sendCommand("~S,SENSOR");
                         Godex.sendCommand("~S,CHECK");
                         Godex.sendCommand("~S,STATUS");
                     }
                 }
                );
        printButton = (Button)

                findViewById(R.id.print);
